...
public class Hauptteil {
    ...
    public static void main(String[] args) {
        String beleidigung[] = { "Du Opfer!", "Du kannst gar nichts!", "Gewitterziege", "Lackaffe", "Holzkopf!",
                "Schafshirn!", "Hochgeschissner!" };
        ...
        Map<String, String> halbgelernt = new HashMap<String, String>();
        ...
        for (int i = 0; i <= 4; i++) {
            ...
            if (antwort.equals(ungelernt.get(frageAktuell))) {
                ...
                halbgelernt.put(frageAktuell, antwortAktuell);
